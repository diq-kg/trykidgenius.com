module.exports = {
  siteMetadata: {
    ...
    description: `KidGenius is the easy way to manage a daycare, childcare, preschool and parent engagement`,
    ...
    keywords: [
      ...
      'after-shcool management software',
      'childcare management software',
      'early childhood management software',
      'daycare management software',
      'childcare software',
      'attendance tracking software',
      'parent communication',
      'daily reports',
      'daycare waitlist management'
    ],
